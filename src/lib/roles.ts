...
const META: Record<string, RoleMeta> = {
  PRINCIPAL: {
    ...
    nav: [
      ...
      { href: "/counseling", label: "Counselling" },
      { href: "/admin/users", label: "Users" },
    ],
    roadmap: ["Reports & transcripts", "System settings", "Audit log viewer"],
    dashboard: "command",
  },
  ADMIN: {
    key: "ADMIN",
  ...
  TEACHER: {
    ...
    tagline: "Your subjects, your marks, your students' growth.",
    purpose: "You shape the academic record — enter marks for your assigned subjects across all sections, and watch each learner progress.",
    accent: "#9c5638",
    nav: [
      { href: "/dashboard", label: "Dashboard" },
      { href: "/academics", label: "Academics" },
